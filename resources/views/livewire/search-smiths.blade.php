<form class="w-full md:w-[50rem]" action="{{ route('searchsmiths') }}">
  <div class="flex items-center border-b border-teal-500 py-4 flex-wrap md:flex-nowrap">
    ...
    @if($searchresults)
    <ul class="appearance-none bg-white border-none rounded text-gray-700 leading-tight focus:outline-none absolute flex flex-row flex-wrap shadow basis-full my-auto md:w-[50rem]" style="top:462px;">
