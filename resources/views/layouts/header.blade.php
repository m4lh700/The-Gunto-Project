<header class="md:h-2/3 overflow-hidden relative" x-data="{ navBarScroll: false }">
  ...
  <nav class="dark:bg-gray-800 fixed w-screen text-white ease-in-out z-10" :class="{ 'bg-white text-black dark:text-white shadow-lg transition duration-200' : navBarScroll }"
  @scroll.window="navBarScroll = (window.pageYOffset > 20) ? true : false">
  <div class="container flex flex-wrap justify-between items-center mx-auto py-4 lg:py-0 px-4 lg:px-0">
    ...
    <button id="menu-btn" data-collapse-toggle="mobile-menu" type="button" class="inline-flex items-center p-2 ml-3 text-sm rounded-lg lg:hidden">
    ...
    <div class="hidden w-full h-full lg:block md:w-auto transition ease-in-out duration-100" id="mobile-menu">
      <!-- Menu items -->
