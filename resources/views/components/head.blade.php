@props(['img', 'height', 'text', 'title', 'searchbar' => false, 'back' => false, 'nextsmith' => false])
  ...
  <div class="flex items-center justify-center h-full w-full bg-gray-900 bg-opacity-80 p-4">
    <div class="text-center md:w-[50rem]">
      ...
      @if($back == true)
        <a href="{{ url()->previous() }}" class="hidden md:block absolute mx-auto flex items-center mt-[-30px] py-25 px-6 text-white text-normal hover:text-teal-500 md:left-20 lg:left-96">
